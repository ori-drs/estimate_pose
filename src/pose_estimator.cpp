                        ...
                        Eigen::Isometry3d * estimate)
{
  ...
  *estimate = Eigen::Isometry3d(ume_estimate);
  ...
  Eigen::Matrix3Xd inlier_ref_uvw = proj_matrix_ * inlier_ref_xyzw;
  Eigen::Matrix2Xd inlier_ref_uv = inlier_ref_uvw.topRows<2>().cwiseQuotient(inlier_ref_uvw.row(2).replicate<2, 1>());
  Eigen::Matrix3Xd inlier_target_uvw = proj_matrix_ * inlier_target_xyzw;
  Eigen::Matrix2Xd inlier_target_uv = inlier_target_uvw.topRows<2>().cwiseQuotient(inlier_target_uvw.row(2).replicate<2, 1>());
  ...
  Eigen::Matrix3Xd reproj_inlier_target_uvw = proj_matrix_ * estimate->matrix() * inlier_target_xyzw;
  Eigen::Matrix2Xd reproj_inlier_target_uv = reproj_inlier_target_uvw.topRows<2>().cwiseQuotient(reproj_inlier_target_uvw.row(2).replicate<2, 1>());
  Eigen::VectorXd reproj_error = (reproj_inlier_target_uv - inlier_ref_uv).colwise().norm();
